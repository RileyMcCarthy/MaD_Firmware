...
public:
	...
	/* Event */
	Callback onArrowsPush;
	Callback onArrowsRelese;
	Callback onUpPush;
	Callback onUpRelease;
	Callback onDownPush;
	Callback onDownRelease;
	Callback onRightPush;
	Callback onRightRelease;
	Callback onLeftPush;
	Callback onLeftRelease;
	Callback onCentralRelease;
	Callback onCentralPush;
	Callback onCentralDoublePush;
	...
	Callback onGP3Rise;
	Callback onGP3Fall;
	Callback onFadeProcess;

	i2cNavKey(uint8_t add);
	void pins(int theSCL, int theSDA);

...
static void ButtonMotionStatus(Button b)
{
    switch (b.name)
    {
...
static void navigationPress(Button b)
{
    complete = true;
}

void MAD::runStatusPage()
{
    complete = false;
    machineEnabled = (machineState.motion.Status() != Motion_Status::STATUS_DISABLED);
    ...
    buttons[0].onPress = ButtonMotionStatus;
    ...
    buttons[1].onPress = ButtonMotionStatus;
    ...
    buttons[2].onPress = navigationPress;
    ...
    while (!complete)
    {
        ...
        machineState.motion.Status(machineEnabled ? Motion_Status::STATUS_ENABLED : Motion_Status::STATUS_DISABLED);
        machineState.update();
